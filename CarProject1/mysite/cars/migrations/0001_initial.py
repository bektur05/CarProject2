# Generated by Django 5.2 on 2025-04-07 06:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'active'), ('completed', 'completed'), ('canceled', 'canceled')], max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Brand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Role', models.CharField(choices=[('администратор', 'администратор'), ('продавец', 'продавец'), ('покупатель', 'покупатель')], default='продавец', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cars.auction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1950), django.core.validators.MaxValueValidator(2030)])),
                ('type_status', multiselectfield.db.fields.MultiSelectField(choices=[('Бензин', 'Бензин'), ('Газ', 'Газ'), ('Электронный', 'Электронный'), ('Гибридный', 'Гибридный ')], max_length=32)),
                ('transmission', models.CharField(choices=[('Авто', 'Авто'), ('Механика', 'Механика')], max_length=200)),
